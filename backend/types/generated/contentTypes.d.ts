...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    classlevel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    statused: Schema.Attribute.Enumeration<['active', 'checkout']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    totalitem: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLectureLecture extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vediourls: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPastPaperPastPaper extends Struct.CollectionTypeSchema {
  collectionName: 'past_papers';
  info: {
    displayName: 'PastPaper';
    pluralName: 'past-papers';
    singularName: 'past-paper';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    boards: Schema.Attribute.Enumeration<
      [
        'BISE Lahore',
        'BISE Rawalpindi',
        'BISE Faisalabad',
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    past_papers: Schema.Attribute.Relation<
      'oneToMany',
      'api::past-paper.past-paper'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::past-paper.past-paper': ApiPastPaperPastPaper;
